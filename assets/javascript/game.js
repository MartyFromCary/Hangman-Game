...
document.onkeyup = function(event) {
    ...
    if (Index == -1) { // Wrong guess
        ...
        if (remaining == 0) {
            MyDoc.status.innerHTML = "Sorry, you lose. Word was \"" + OrigWord + "\" Press any key to start again";
            Started = false;
            return;
        }
        return;
